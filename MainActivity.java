package com.example.weather_feather;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                url="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=1e1292bd0da5b919ce54cb1f3e030167";
                try{
                    if(city!=null){
